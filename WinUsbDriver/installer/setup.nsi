; *************************************************************************
;   This is the NSIS (http://nsis.sf.net) installer for the custom        *
...
; General
  ...
  ; NOTE: the version should be the same as the one in k95_winusbdriver.inf
  !define OUTPUT_DIR		      "..\binaries\"
  !define PRODUCT_NAME            "Corsair K95 Custom Controller for Windows"
  !define PRODUCT_VERSION         "1.0.0"
  !define PRODUCT_PUBLISHER       "Sverrir Sigmundarson"
  !define PRODUCT_WEBSITE		  "http://sverrirs.github.io/corsairk95"
  !define PRODUCT_WEBSITE_TITLE	  "CorsairK95.NET Website"
  !define PRODUCT_WEBSITE_DESC	  "Visit the CorsairK95.NET Website for more information and examples"
...
proceed:
  ...
  File ..\driver\k95_winusbdriver.inf
  ...
  ;${If} ${AtMostWin7}
    ...
    DetailPrint "Running the dpinst utility to install Corsair K95's drivers"
  ...
  DetailPrint "Attempting to install driver for currently connected Corsair K95 hardware"
...
Section "Uninstall"
  ...
  DetailPrint "Running the pnputil utility to uninstall Corsair K95's drivers"
